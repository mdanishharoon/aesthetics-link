...
function ProductRail({
  ...
  return (
    <div className={`product__rail${reverse ? " product__rail--reverse" : ""}`}>
      <div className="product__rail-controls d-none d-md-flex">
        <button
          type="button"
          className="slider-arrow slider-arrow--ghost"
          onClick={() => stepArrow(-1)}
          aria-label="Previous products"
        >
          <span className="product__rail-arrow product__rail-arrow--prev">
            <ArrowLongIcon />
          </span>
        </button>
        <button
        ...
        >
          <span className="product__rail-arrow">
            <ArrowLongIcon />
          </span>
        </button>
      </div>
...
const varnayaProducts: ProductCardProps[] = [
  {
    ...
    <section id="explore" style={{ position: "relative", margin: 0 }}>
      ...
      <div className="half__grid reveal-up" data-reveal>
        ...
        <div className="half__grid-content">
          ...
          <div className="half__grid-product">
            <ProductRail products={varnayaProducts} />
          </div>
          <p className="text-uppercase maxwidth">
            Stay glowing and healthy without having to think about it.
          </p>
